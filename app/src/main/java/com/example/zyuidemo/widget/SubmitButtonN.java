...
public class SubmitButtonN extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public SubmitButtonN(Context context) {
        super(context);
        init(null);
    }

    public SubmitButtonN(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public SubmitButtonN(Context context, AttributeSet attrs, int defStyleAttr) {
